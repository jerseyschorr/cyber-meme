...
def myreverse(input, rtl):
  if (rtl):
    return reversed(range(input))

  return range(input)



def scrollText(TEXT='Purim Sameach!', lang='en', rtl=False, color=False):

  if (lang == 'jp'):
    FONT = ('/usr/share/fonts/truetype/fonts-japanese-gothic.ttf', 14)
  elif (lang == 'he'):
    # FONT = ('/usr/share/fonts/truetype/culmus/HadasimCLM-Bold.ttf', 12)
    # FONT = ('/usr/share/fonts/truetype/culmus/FrankRuehlCLM-MediumOblique.ttf', 16)
    FONT = ('/usr/share/fonts/truetype/culmus/SimpleCLM-BoldOblique.ttf', 16)
  else:
    FONT = ('/usr/share/fonts/truetype/freefont/FreeSansBold.ttf', 12)
  # FONT = ('/usr/share/fonts/truetype/roboto/hinted/Roboto-Black.ttf', 12)
  ...
  while not a_list:
      for scroll in myreverse(text_width - width, rtl):
          # print scroll, text_width, width
          if a_list:
              break
